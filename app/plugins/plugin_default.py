...
class Plugin:
    ...
    plugin_params = {
        ...
        'std_dev_horizon': 12     # Optional: for rolling standard deviation calculation
    }
    ...
    def process(self, data):
        ...
        # Step 5: Drop rows with NaN values resulting from shifts/rolling calculations
        ...
        # Step 6: Reset index and ensure chronological order
